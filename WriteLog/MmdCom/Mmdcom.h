...
template <class T>
class CWlogCabrilloFileIteratorImpl : public CWlogEmbeddable<IWlogCabrilloFileIterator, T>
{
public:
	CWlogCabrilloFileIteratorImpl(T* p) : CWlogEmbeddable<IWlogCabrilloFileIterator, T>(p) {};
	STDMETHOD(GetIterator)(IWlogCabrillo** pIterator)
	{
		return m_Parent->GetIterator(pIterator);
	}
};
...
class CWlogCabrilloIterator : public IWlogCabrillo
{
public:
